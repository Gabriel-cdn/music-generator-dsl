 ...
 * @generated
 */
public class MusicgeneratorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MusicgeneratorPackage.COMPOSITION: {
				Composition composition = (Composition)theEObject;
				T result = caseComposition(composition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MusicgeneratorPackage.PART: {
				Part part = (Part)theEObject;
				T result = casePart(part);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MusicgeneratorPackage.VERSE: {
				Verse verse = (Verse)theEObject;
				T result = caseVerse(verse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MusicgeneratorPackage.STRUCTURE: {
				Structure structure = (Structure)theEObject;
				T result = caseStructure(structure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MusicgeneratorPackage.PARTS: {
				Parts parts = (Parts)theEObject;
				T result = caseParts(parts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MusicgeneratorPackage.RHYTHM: {
				Rhythm rhythm = (Rhythm)theEObject;
				T result = caseRhythm(rhythm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MusicgeneratorPackage.INFO: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rhythm</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rhythm</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
