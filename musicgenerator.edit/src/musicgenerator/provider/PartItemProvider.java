...
/**
 * This is the item provider adapter for a {@link musicgenerator.Part} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MusicgeneratorPackage.Literals.PART__TITLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MusicgeneratorPackage.Literals.PART__VERSE);
		}
	...
	public String getText(Object object) {
		String label = ((Part)object).getTitle();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Part.class)) {
			case MusicgeneratorPackage.PART__TITLE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case MusicgeneratorPackage.PART__VERSE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MusicgeneratorPackage.Literals.PART__VERSE,
				 MusicgeneratorFactory.eINSTANCE.createVerse()));
	}
